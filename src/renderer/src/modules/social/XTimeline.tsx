      ...
      <SectionCard
        ...
        actions={
          <button
            ...
            className="flex items-center gap-1 text-[10px] text-muted t-colors hover:text-accent"
          >
        ...
        {status === 'failed' ? (
          <div className="flex flex-col items-center gap-2 py-6 text-center">
            ...
            <button
              type="button"
              onClick={() => window.open(`https://x.com/${handle}`, '_blank')}
              className="flex items-center gap-1.5 rounded border border-accent bg-accent/15 px-3 py-1.5 text-[11px] text-accent t-colors hover:bg-accent/25"
            >
